...
extern NSString *const RYkSSKeychainErrorDomain;

/** Account name. */
extern NSString *const RYkSSKeychainAccountKey;
 ...
 */
extern NSString *const RYkSSKeychainCreatedAtKey;

/** Item class. */
extern NSString *const RYkSSKeychainClassKey;

/** Item description. */
extern NSString *const RYkSSKeychainDescriptionKey;

/** Item label. */
extern NSString *const RYkSSKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const RYkSSKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const RYkSSKeychainWhereKey;
 ...
 */
@interface RYSSKeychain : NSObject
