...
@interface RYFMResultSet (Private)
- (NSMutableDictionary *)columnNameToIndexMap;
- (void)setColumnNameToIndexMap:(NSMutableDictionary *)value;
@end

@implementation RYFMResultSet
@synthesize query=_query;
@synthesize columnNameToIndexMap=_columnNameToIndexMap;
@synthesize statement=_statement;

+ (id)resultSetWithStatement:(RYFMStatement *)statement usingParentDatabase:(RYFMDatabase*)aDB {
    
    RYFMResultSet *rs = [[RYFMResultSet alloc] init];
...
- (void)setParentDB:(RYFMDatabase *)newDb {
    _parentDB = newDb;
}
