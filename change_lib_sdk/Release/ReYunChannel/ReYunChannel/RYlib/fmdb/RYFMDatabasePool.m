...
@interface RYFMDatabasePool()

- (void)pushDatabaseBackInPool:(RYFMDatabase*)db;
- (RYFMDatabase*)db;

@end


@implementation RYFMDatabasePool
...
- (RYFMDatabase*)db {
    ...
    [self executeLocked:^() {
        ...
        if (db) {
            ...
            db = [RYFMDatabase databaseWithPath:_path];
        }
